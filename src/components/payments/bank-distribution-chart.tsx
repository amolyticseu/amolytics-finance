...
import type { BankDistributionSlice } from "@/lib/payments/presentation"
import { formatEur } from "@/lib/format"

type BankDistributionChartProps = {
  data: BankDistributionSlice[]
}
  ...
  if (data.length === 0) {
    return (
      <p className="text-sm text-af-text-secondary">
        No EUR movements in the current register to chart.
      </p>
    )
  }

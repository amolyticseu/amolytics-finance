...
import type { ExpenseTrendPoint } from "@/lib/expenses/presentation"
    ...
    <div className="h-[300px] w-full min-w-0">
      <ResponsiveContainer width="100%" height={300}>
        <AreaChart data={data} margin={{ top: 8, right: 12, left: 0, bottom: 0 }}>
          <defs>
            <linearGradient id="expenseTotalFill" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stopColor="var(--af-warning)" stopOpacity={0.35} />
              <stop offset="100%" stopColor="var(--af-warning)" stopOpacity={0.02} />
            </linearGradient>
            <linearGradient id="expenseRecurringFill" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stopColor="var(--af-primary-blue)" stopOpacity={0.3} />
              <stop offset="100%" stopColor="var(--af-primary-blue)" stopOpacity={0.02} />
            </linearGradient>
            <linearGradient id="expenseRebillableFill" x1="0" y1="0" x2="0" y2="1">
          ...
          <Area
            ...
            fill="url(#expenseRebillableFill)"
            strokeWidth={2}
          />
        </AreaChart>
      </ResponsiveContainer>
